...
export const mockOrders: Order[] = [
  ...
  },
  {
    ...
    items: [
      { productId: 'prod2', name: 'Onion', quantity: 5, unit: 'kg', priceAtConfirmation: 30, costAtConfirmation: 22 },
  ...
  },
  {
  ...
  },
   {
    ...
    customerAddress: '101, Jayanagar, Bangalore',
    items: [
      { productId: 'prod6', name: 'Potato', quantity: 5, unit: 'kg', priceAtConfirmation: 25, costAtConfirmation: 18 },
    ],
    totalAmount: 125,
    walletAmountUsed: 0,
    cashToPay: 125,
    status: OrderStatus.PendingDenial,
    deliveryPartnerId: 'del1',
  ...
  },
  {
    ...
    customerAddress: '123, MG Road, Bangalore',
    items: [
      { productId: 'prod1', name: 'Tomato', quantity: 3, unit: 'kg', priceAtConfirmation: 40, costAtConfirmation: 30 },
      { productId: 'prod2', name: 'Onion', quantity: 2, unit: 'kg', priceAtConfirmation: 30, costAtConfirmation: 22 },
    ],
    totalAmount: 180,
